...
from ops import *
from utils import *
from config import _300W_LP_DIR, _3DMM_DEFINITION_DIR
...
class DCGAN(object):
    def __init__(self, sess, config, devices=None):
        ...
        print self.samples_dir + "/" + self.model_dir
    ...
    def train(self, config):
        ...
        for epoch in xrange(epoch0, config.epoch):
            ...
            print "Epoch =",epoch
            print "Number of batchs =",batch_idxs
            deseasContinuar = raw_input()
            for idx in xrange(0, batch_idxs):
                ...
                print "Terminado el primer proceso"
                ...
                print "Todo realizado correctamente"
